...
dir=/lus/work/CT1/ige2071/aalbert/${CONFIG}/${CONFIG}-${CASE}-S/1d/${REG}
mkdir -p $dir
cd $dir
...
for month in $MONTH; do
    ...
    for day in $(seq $day1 $day2); do
		...
		if [ ! -f  ${fileo}.nc ]; then echo ${fileo}; /lus/work/CT1/ige2071/aalbert/git/CDFTOOLS/bin/cdfmoy -l $files -o $fileo -nc4; rm ${fileo}2.nc; fi
