...
for reg in GULF; do
	for month in $(seq 1 12); do
		...
		cat tmp_extract_3D_eNATL60-${case}_${reg}_*_${month}.ksh > tmp_extract_3D_eNATL60-${case}_${reg}_all_${month}.ksh
		chmod +x tmp_extract_3D_eNATL60-${case}_${reg}_all_${month}.ksh
		liste="$liste ./tmp_extract_3D_eNATL60-${case}_${reg}_all_${month}.ksh"
	done
done
